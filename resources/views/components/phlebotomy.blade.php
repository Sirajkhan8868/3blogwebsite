        ...
        <section>
            <div class="text-sec row g-4">
                ...
                <div class="col-12 col-md-6 text-start mt-3 mt-md-5">
                    ...
                    <div class="row g-2 mt-4 px-md-5">
                        <div class="col-12 col-md-4 ">
                            <div class="card h-100 text-center p-3 border-dotted" style="background-color: #ffffff; border: 1px solid #f8f7f7; border-radius: 13px;">
                                <h6 class="mb-4 ">COURSE LEVEL</h6>
                                <h4 class="text-primary" style="font-size: 16px;">Level 3</h4>
                            </div>
                        </div>
                        <div class="col-12 col-md-4">
                            <div class="card h-100 text-center p-3 border-dotted" style="background-color: #ffffff; border: 1px solid #f8f7f7; border-radius: 13px;">
                                <h6 class="mb-4">COURSE TYPE</h6>
                                <h4 class="text-primary" style="font-size: 16px;">CPD Accredited</h4>
                            </div>
                        </div>
                        <div class="col-12 col-md-4">
                            <div class="card h-100 text-center p-3 border-dotted" style="background-color: #ffffff; border: 1px solid #f8f7f7; border-radius: 13px;">
                                <h6 class="mb-4">AWARDING BODY</h6>
                                <h4 class="text-primary" style="font-size: 16px;">Step Ahead CPD</h4>
                            </div>
                        </div>
                        <div class="col-12 col-md-4">
                            <div class="card h-100 text-center p-3 border-dotted" style="background-color: #ffffff; border: 1px solid #f8f7f7; border-radius: 13px;">
                                <h6 class="mb-4">DURATION</h6>
                                <h4 class="text-primary" style="font-size: 16px;">1 Day (10 am – 5 pm)</h4>
                            </div>
                        </div>
                        <div class="col-12 col-md-4">
                            <div class="card h-100 text-center p-3 border-dotted" style="background-color: #ffffff; border: 1px solid #f8f7f7; border-radius: 13px;">
                                <h6 class="mb-4">STUDY METHOD</h6>
                                <h4 class="text-primary" style="font-size: 16px;">Classroom training</h4>
                            </div>
                        </div>
                        <div class="col-12 col-md-4">
                            <div class="card h-100 text-center p-3 border-dotted" style="background-color: #ffffff; border: 1px solid #f8f7f7; border-radius: 13px;">
                                <h6 class="mb-4">CERTIFICATE</h6>
                                <h4 class="text-primary" style="font-size: 16px;">Certificate Included</h4>
                            </div>
                        </div>
                    </div>
