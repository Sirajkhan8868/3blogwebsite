...
@section('content')
    <section style="min-height: 50vh; background-image: linear-gradient(rgba(0, 32, 96, 0.8), rgba(0, 64, 128, 0.8)), url('{{ asset('assets/site/01.webp') }}'); background-size: cover; background-position: center;">
        <div class="text-sec d-flex justify-content-center align-items-center" style="height: 50vh; text-align: center;">
            <div class="">
                <h1 class="text-white">Additional Courses
                </h1>
            </div>
        </div>
    </section>
                        ...
                        <div class="row px-5 g-3 pt-5">
                            <div class="col-sm-3 p-2 text-center">
                                <div style="border: 2px solid grey; border-radius: 8px; background-color: transparent;">
                                    <img src="{{ asset('assets/site/Anti-Bullying.webp') }}" alt="" style="width: 100%; height: auto;">
                                    <div class="px-3 mt-3">
                                        <p>Anti-Bulling $ Anti Harassment</p>
                            ...
                            <div class="col-sm-3 p-2 text-center">
                                <div style="border: 2px solid grey; border-radius: 8px;  background-color: transparent;">
                                    <img src="{{ asset('assets/site/Conflict-Resolution.webp') }}" alt="" style="width: 100%; height: auto;">
                                    <div class="px-3 mt-3">
                                        <p >Conflict Resolution & setting</p>
                                        <h6 class="fw-bolder" style="text-decoration: underline">$35.00</h6>
                            ...
                            <div class="col-sm-3  text-center">
                                <div style="border: 2px solid grey; border-radius: 8px;  background-color: transparent;">
                                    <img src="{{ asset('assets/site/Driving-Safety.webp') }}" alt="" style="width: 100%; height: auto;">
                                    <div class="px-3 mt-3">
                                        <p >Driving Safety</p>
                                        <h6 class="fw-bolder" style="text-decoration: underline">$34.00</h6>
                            ...
                            <div class="col-sm-3  text-center">
                                <div style="border: 2px solid grey; border-radius: 8px;  background-color: transparent;">
                                    <img src="{{ asset('assets/site/Drug-and-Alcohol.webp') }}" alt="" style="width: 100%; height: auto;">
                                    <div class="px-3 mt-3">
                                        <p >Drug and Alcohol Awarness</p>
                            ...
                            <div class="col-sm-3  text-center">
                                <div style="border: 2px solid grey; border-radius: 8px;  background-color: transparent;">
                                    <img src="{{ asset('assets/site/Duty-of-Candour1.webp') }}" alt="" style="width: 100%; height: auto;">
                                    <div class="px-3 mt-3">
                            ...
                            <div class="col-sm-3  text-center">
                                <div style="border: 2px solid grey; border-radius: 8px;  background-color: transparent;">
                                    <img src="{{ asset('assets/site/Information.webp') }}" alt="" style="width: 100%; height: auto;">
                                    <div class="px-3 mt-3">
                                        <p >Information </p>
                                        <h6 class="fw-bolder" style="text-decoration: underline">34.000</h6>
                            ...
                            <div class="col-sm-3  text-center">
                                <div style="border: 2px solid grey; border-radius: 8px;  background-color: transparent;">
                                    <img src="{{ asset('assets/site/Prevent-Training.webp') }}" alt="" style="width: 100%; height: auto;">
                                    <div class="px-3 mt-3">
                                        <p >Prevent Training</p>
                                        <h6 class="fw-bolder" style="text-decoration: underline">$35.000</h6>
                            ...
                            <div class="col-sm-3  text-center">
                                <div style="border: 2px solid grey; border-radius: 8px;  background-color: transparent;">
                                    <img src="{{ asset('assets/site/Preventing.webp') }}" alt="" style="width: 100%; height: auto;">
                                    <div class="px-3 mt-3">
                                        <p>Construction Equipment Planning </p>
                                        <h6 class="fw-bolder" style="text-decoration: underline">$35.000</h6>
                            ...
                            <div class="col-sm-3 p-2 text-center">
                                <div style="border: 2px solid grey; border-radius: 8px;  background-color: transparent;">
                                    ...
                                    <div class="px-3 mt-3">
                                        <p>Single Subject  in Construction </p>
                                        <h6 class="fw-bolder" style="text-decoration: underline">$35.000</h6>
